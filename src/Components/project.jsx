            ...
            <Col md={4} sm={6} key={index}>
                <Zoom cascade delay={delay} triggerOnce={true}>
                    <Card className="card-project " >
                        <CardImg src={projectimg} className="img-project"></CardImg>
                        <div className="card__content">
                            <CardTitle className="fs-4 fw-bold">{carditem.titleJob}</CardTitle>
                            <Button href={carditem.url} className="mt-2 bg-dark border-dark">Lihat</Button>
                        </div>
                    </Card>


                    {/* <Card classNameName="cardProject">
                        <CardImg src={projectimg}></CardImg>
                        <CardBody classNameName="text-start">
                            <CardTitle classNameName="fs-4 fw-bold">{carditem.titleJob}</CardTitle>
                            <Button href={carditem.url} classNameName="mt-2 w-100 bg-dark border-dark">Lihat</Button>
                        </CardBody>
                    </Card> */}
                </Zoom>
            </Col>
